# Informe de Auditoría y Mapa Funcional del Sistema ArborTrust

**ID del Hito:** Codebase Audit and Functional Mapping  
**Fecha de Auditoría:** 2026-06-14T18:02:00Z  
**Estado del Código:** Read-Only Investigation (Sin Modificaciones)

---

## 1. Arquitectura de Actores y Permisos en la UI

El sistema ArborTrust define un conjunto claro de perfiles de usuario o actores que interactúan con la plataforma, tanto para registrar eventos físicos de la madera como para realizar auditorías regulatorias bajo los Lineamientos de OSINFOR.
